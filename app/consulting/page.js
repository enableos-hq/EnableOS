...
const TESTIMONIALS = [
  // Uncomment and duplicate this structure to add testimonials:
  // {
  //   quote: "Vedika rebuilt our entire onboarding in 3 weeks. Our reps hit quota a month earlier.",
  //   name: "First Last",
  //   role: "Head of Sales",
...
const SERVICES = [
  {
    ...
    description: 'New reps stop guessing. A structured ramp program that tracks progress, surfaces gaps, and gets people productive in weeks — not quarters.',
  },
  {
    emoji: '📘',
    title: 'Playbook Creation',
    description: 'Tribal knowledge turns into repeatable systems. Outbound sequences, qualification frameworks, objection handling — documented and usable.',
  },
  {
    emoji: '🎯',
    title: 'Coaching Frameworks',
    description: 'Call reviews and 1:1s that actually change behavior. AI-assisted sentiment tracking so no one slips through the cracks.',
  },
  {
    emoji: '⚙️',
    title: 'Enablement Systems',
    description: 'One workspace replaces six tools. Intake, content, pulse checks, forecasting — all visible, all trackable, all proving ROI.',
  },
];
...
const STEPS = [
  {
    ...
    description: '30 minutes to understand the sales motion, team size, and where things break. No pitch deck — just questions.',
  },
  {
    number: '02',
    label: 'I build',
    title: 'Audit & workspace',
    description: 'Gaps get mapped. Systems get designed. A fully configured EnableOS workspace gets loaded with everything the team needs.',
  },
  {
    number: '03',
    label: 'You grow',
    title: 'Ongoing support',
    description: 'Launch call, rep walkthroughs, and monthly check-ins. The workspace evolves as the team scales.',
  },
];
  ...
  return (
    <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
      ...
      <span style={{
        ...
        fontSize: '18px', fontWeight: 700, color: '#FDFBFF', letterSpacing: '-0.02em',
      }}>
        Enable<em style={{ fontStyle: 'normal', opacity: 0.7 }}>OS</em>
      </span>
    </a>
  );
}
    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        :root {
          --plum: #1A1235;
          --lavender: #7C5CFC;
          --lavender-soft: #7B6ED6;
          --lavender-glow: #9B7EFF;
          --cream: #FDFBFF;
          --cream-warm: #F8F6FF;
          --muted: #8b82a0;
          --border: #2a2350;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .c-nav-links a {
          ...
          color: rgba(253,251,255,0.7); text-decoration: none; transition: color 0.2s;
        }
        ...
        .c-hero {
          ...
          background: var(--plum); overflow: hidden;
        }
        .c-hero-aurora {
          position: absolute; inset: 0; opacity: 0.15; pointer-events: none;
          background:
            radial-gradient(ellipse 80% 60% at 20% 80%, #7C5CFC 0%, transparent 70%),
            radial-gradient(ellipse 60% 50% at 80% 20%, #9B7EFF 0%, transparent 70%),
            radial-gradient(ellipse 40% 40% at 50% 50%, #5a3fd4 0%, transparent 60%);
        }
        .c-hero-content { position: relative; z-index: 2; max-width: 720px; }
        .c-hero-eyebrow {
          font-family: var(--font-body); font-size: 13px; font-weight: 600;
          color: var(--lavender); letter-spacing: 0.08em; text-transform: uppercase;
        ...
        .c-hero-sub {
          ...
          color: rgba(253,251,255,0.6); max-width: 560px; margin: 0 auto 40px;
          opacity: 0; animation: fadeUp 0.6s 0.6s forwards;
        }
        .c-hero-cta {
          display: inline-block; font-family: var(--font-body); font-size: 16px;
          font-weight: 600; color: var(--plum); background: var(--cream);
        ...
        .c-section-dark {
          background: var(--plum); padding: 100px 24px;
        }
        .c-section-tint {
          background: var(--cream-warm); padding: 100px 24px;
        }
        .c-section-header {
        ...
        .c-service-card {
          background: white; border: 1px solid #E8E2F0; border-radius: 16px;
          padding: 36px 28px; transition: transform 0.25s, box-shadow 0.25s;
        }
        .c-service-card:hover {
          transform: translateY(-4px); box-shadow: 0 12px 40px rgba(26,18,53,0.08);
        }
        .c-service-emoji { font-size: 28px; margin-bottom: 16px; display: block; }
        .c-service-card h3 {
          font-family: var(--font-display); font-size: 18px; font-weight: 400;
          margin-bottom: 12px; color: var(--plum);
        }
        .c-service-card p {
        ...
        .c-proof-story {
          ...
          color: rgba(253,251,255,0.7); max-width: 640px; margin: 0 auto 56px;
          text-align: center;
        }
        ...
        .c-metric-value {
          ...
          font-weight: 700; color: var(--lavender-glow); margin-bottom: 6px;
        }
        .c-metric-label {
          font-size: 13px; color: rgba(253,251,255,0.5); line-height: 1.4;
        }
        ...
        .c-testimonial-quote {
          ...
          color: var(--plum); margin-bottom: 20px; font-style: italic;
        }
        .c-testimonial-name {
          font-family: var(--font-body); font-size: 14px; font-weight: 600;
          color: var(--plum);
        ...
        .c-testimonials-empty {
          ...
          border: 2px dashed #E2DCF0; border-radius: 20px;
          max-width: 600px; margin: 0 auto;
        }
        .c-testimonials-empty p {
          font-size: 15px; color: var(--muted); line-height: 1.6;
        }
        .c-testimonials-empty p:first-child {
          font-family: var(--font-display); font-size: 18px; color: #6b6084;
          margin-bottom: 8px;
        }
        ...
        .c-steps::before {
          ...
          height: 2px; background: linear-gradient(90deg, var(--lavender), var(--lavender-glow));
          opacity: 0.3;
        }
        .c-step { text-align: center; position: relative; padding: 0 20px; }
        .c-step-dot {
          width: 48px; height: 48px; border-radius: 50%;
          background: linear-gradient(135deg, var(--lavender), var(--lavender-glow));
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 20px; font-family: var(--font-body); font-size: 16px;
        ...
        .c-final-cta-aurora {
          ...
          background:
            radial-gradient(ellipse 60% 50% at 30% 70%, #7C5CFC 0%, transparent 70%),
            radial-gradient(ellipse 50% 40% at 70% 30%, #9B7EFF 0%, transparent 70%);
        }
        .c-final-cta h2 {
          font-family: var(--font-display); font-size: clamp(26px, 3.5vw, 38px);
        ...
        .c-final-cta p {
          font-size: 15px; color: rgba(253,251,255,0.5); margin-bottom: 36px;
          position: relative; z-index: 2;
        }
        .c-final-cta a {
          display: inline-block; font-family: var(--font-body); font-size: 16px;
        ...
        /* ─── Footer ─── */
        .c-footer {
          padding: 40px 24px; text-align: center; background: var(--plum);
          border-top: 1px solid rgba(124,92,252,0.15);
        }
        .c-footer p {
          font-size: 13px; color: rgba(253,251,255,0.3);
        }
        ...
        @media (max-width: 768px) {
          .c-nav { padding: 14px 20px; }
          .c-nav-links { gap: 16px; }
          .c-nav-links a { font-size: 13px; }
          .c-hero { padding: 100px 20px 60px; min-height: auto; }
          .c-metrics { grid-template-columns: repeat(2, 1fr); gap: 24px; }
          .c-steps { grid-template-columns: 1fr; gap: 40px; }
          .c-steps::before { display: none; }
          .c-section, .c-section-dark, .c-section-tint { padding: 72px 20px; }
          .c-services { grid-template-columns: 1fr; }
        }

        @media (max-width: 480px) {
          .c-nav-links a:not(.c-nav-cta) { display: none; }
      ...
      <nav className="c-nav" style={{
        background: `rgba(26,18,53,${navOpacity})`,
        ...
        <div className="c-nav-links">
          ...
          <a href="https://calendly.com/enableos-hq/30min" className="c-nav-cta"
      ...
      <section className="c-hero">
        ...
        <div className="c-hero-content">
          ...
          <p className="c-hero-sub">
            Onboarding, playbooks, coaching systems, and the workspace to run it all —
            built by someone who's done this from both sides of the sales floor.
          </p>
          <a href="https://calendly.com/enableos-hq/30min" className="c-hero-cta"
      ...
      <section className="c-section" id="services">
        <div className="c-section-header">
          ...
          <p>
            Every engagement starts with a conversation and ends with a system the team
            actually uses. Not a doc that collects dust.
          </p>
        </div>
      ...
      <section className="c-section-dark" id="proof">
        ...
        <div className="c-proof">
          <p className="c-proof-story">
            ...
            conversion grew <strong>5% quarter over quarter.</strong> Meeting no-shows dropped <strong>10% QoQ.</strong> Playbooks
            that started as personal outbound experiments were adopted as team-wide standards.
          </p>
      ...
      <section className="c-final-cta">
        ...
        <a href="https://calendly.com/enableos-hq/30min" target="_blank" rel="noopener noreferrer">
      ...
      <footer className="c-footer">
        <p>
          © 2026 <a href="/">EnableOS</a>. Built in Bangalore.
          {' · '}
          <a href="mailto:enableos.hq@gmail.com">enableos.hq@gmail.com</a>
          {' · '}
          <a href="https://www.linkedin.com/in/vedikaagarwal00/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        </p>
      </footer>
    </>
  );
